...
mysql_import_vmail_users()
{
    ...
    cp -f ${SAMPLE_DIR}/mmailbsd/mailbsd.mysql ${RUNTIME_DIR}/mailbsdl.sql
    ...
    perl -pi -e 's#^-- (USE.*)#${1}#g' ${RUNTIME_DIR}/mailbsd.sql
    ...
    ${MYSQL_CLIENT_ROOT} -e "SOURCE ${RUNTIME_DIR}/mailbsd.sql;"
